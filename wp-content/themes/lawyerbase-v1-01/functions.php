<?php
	...
	*/
	...
	define('THEME_FULL_NAME', 'Lawyer Base');
	define('THEME_SHORT_NAME', 'layb');
	define('THEME_SLUG', 'lawyerbase');
	...
	include_once( 'include/widget/recent-practice-widget.php');
	include_once( 'include/widget/popular-post-widget.php');
	include_once( 'include/widget/attorney-slider-widget.php');	
